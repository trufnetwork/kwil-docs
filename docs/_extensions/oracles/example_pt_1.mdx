...
`credit_account` resolution found in the [default Kwil implementation](https://github.com/trufnetwork/kwil-db/tree/v0.7.1/extensions/resolutions/credit/credit.go). It is purely for example purposes, since the default implementation
