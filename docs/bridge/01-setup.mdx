...
To deploy the bridge Solidity contracts, see the [guide in the source repo](https://github.com/trufnetwork/rewards_contracts/blob/main/docs/tasks.md#deploy).

To run the relayer service, see [the documentation](https://github.com/trufnetwork/rewards_contracts/blob/main/docs/poster.md).
