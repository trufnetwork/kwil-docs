...
fields. See the
[godocs](https://pkg.go.dev/github.com/trufnetwork/kwil-db/extensions/consensus)
for reference.
...
as per the previous section. See [test node](https://github.com/trufnetwork/kwil-db/blob/6014154ee740947f9e62c7b3e7b1031e835b05bf/test/nodes/fork/gremlin.go)
for an example.
