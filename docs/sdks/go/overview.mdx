...
The Go Client documentation and tutorial are available in the [`kwil-db` GitHub repository](https://github.com/trufnetwork/kwil-db). The repository also contains an example to help you get started with the Go Client.

- [Go Client Documentation](https://github.com/trufnetwork/kwil-db/tree/main/core/client)
- [Go Client Example](https://github.com/trufnetwork/kwil-db/tree/main/core/client/example)
