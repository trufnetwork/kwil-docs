...
- [`kwild`](https://github.com/trufnetwork/kwil-db/releases)
...
binaries on [Github](https://github.com/trufnetwork/kwil-db/releases).
...
[README](https://github.com/trufnetwork/kwil-db/blob/main/README.md). In
