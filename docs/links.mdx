...
| Kwil JS/TS SDK | NPM package for JavaScript / TypeScript SDK | https://www.npmjs.com/package/@trufnetwork/kwil-js |
| Discord | The Kwil Discord server | https://discord.com/invite/HzRPZ59Kay |
| Twitter | The Kwil Twitter account | https://twitter.com/trufnetwork |
| Github | The Kwil Github repo | https://github.com/trufnetwork |
