...
subscription disconnections, Ethereum reorgs, and other edge cases. For a production-ready implementation of this event listener, please refer to the [Kwil EVM Deposits Listener](<https://github.com/trufnetwork/kwil-db/tree/v0.7.1/extensions/listeners/eth_deposits>) that is
